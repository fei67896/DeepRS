...
News
-----
12/27/2018 : Add `AutoInt <./Features.html#autoint-automatic-feature-interaction>`_ . `Changelog <https://github.com/shenweichen/DeepCTR/releases/tag/v0.2.1>`__

12/22/2018 : Add `xDeepFM <./Features.html#xdeepfm>`_ and automatic check for new version. `Changelog <https://github.com/shenweichen/DeepCTR/releases/tag/v0.2.0>`__

12/19/2018 : DeepRS is compatible with tensorflow from ``1.4-1.12`` except for ``1.7`` and ``1.8``. `Changelog <https://github.com/shenweichen/DeepCTR/releases/tag/v0.1.6>`__

11/24/2018 : DeepRS is released! `PyPi <https://pypi.org/project/DeepRS/>`_.
...
.. toctree::
   ...
   Layers API<deeprs.layers.rst>
   Activations API<deeprs.activations.rst>
   Sequence API<deeprs.sequence.rst>
